...
{
	public class IsosurfaceV5Tables
	{
		public int[] PackingTables()
		{
			int tableSize = TriangleNum.Length + EdgeEndVert.Length + Triangle.Length;
			int[] packedTables = new int[tableSize];
			int count = 0;

			for (int i = 0; i < TriangleNum.Length; i++)
			{
				packedTables[count] = TriangleNum[i];
				count++;
			}

			int [] EdgeEndVert1DArray = EdgeEndVert.Cast<int>().ToArray();
			for (int i = 0; i < EdgeEndVert.Length; i++)
			{
				packedTables[count] = EdgeEndVert1DArray[i];
				count++;
			}

			int [] Triangle1DArray = Triangle.Cast<int>().ToArray();
			for (int i = 0; i < Triangle.Length; i++)
			{
				packedTables[count] = Triangle1DArray[i];
				count++;
			}
		...
		#region tables
		public int [] TriangleNum = new int[256]
		{
		...
		public int [,] EdgeEndVert = new int[12, 2] 
		{
			{0, 1}, //  0
			{0, 2}, //  1
			{1, 3}, //  2
